var ccmi18n = {
  ...
  helpPopupLoginMsg: "Get more help on your question by posting it to the concrete5 help centre on concrete5.org",
  ...
  customizeSearch: "Customise Search",
...
var ccmi18n_helpGuides = {
  ...
  'personalize': [
    {title: "Properties Panel", text: "The properties panel controls data and details about the current page including design customisations. To open the properties panel, click the gear icon."},
    {title: "Page Design", text: "From here you can change your page template and customise your page's styles."},
    {title: "Customise", text: "Click here to load the theme customiser for the page."}
  ],
  'toolbar': [
